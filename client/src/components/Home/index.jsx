  ...
  <div>
    <div className="container">
      ...
      <p>
        ...
        I always am excited and enjoy meeting new families and connect with each member. 
      </p>

      <p>
        With No Place Like Home, I try to make each experience as little as different for the loved pets in families for any occasion.
        There are many services that come in addition the offered petsitting services... You can find more about these below.
      </p>
    </div>
